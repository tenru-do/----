...
Set re = CreateObject("VBScript.RegExp")
re.Global = True
re.Pattern = "朝食|夕食|2食|２食|二食|食事|バイキング|グルメ|放題|素泊|ルームチャージ|ブレックファースト|ディナー|レストラン|和食|洋食|中華|軽食"
Set r = Range("j7:j3506").Find("*")
If r Is Nothing Then End
endp = r.Address
Do
